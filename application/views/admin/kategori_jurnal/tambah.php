    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">Tambah Kategori Jurnal</h4>
            </div>
...
// Form
echo form_open('admin/kategori_jurnal');
?>

<div class="form-group">
<label>Nama kategori</label>
<input type="text" name="nama_kategori_jurnal" placeholder="Nama kategori Jurnal" value="<?php echo set_value('nama_kategori_jurnal') ?>" required class="form-control">
</div>
