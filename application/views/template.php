...
<body>
  ...
  <div class="w3-top">
    <div class="w3-bar w3-npu w3-card w3-left-align w3-large">
      ...
      <a href="<?php echo base_url() ?>" class="w3-padding-large w3-bar-item w3-button w3-hover-white w3-hide-large"><strong>LPPM Nusa Putra</strong></a>
      <a href="<?php echo base_url() ?>" class="w3-bar-item w3-button w3-hide-small w3-padding-large w3-hover-white">Home</a>
...
<!-- Header -->
<header class="w3-container w3-npu w3-center w3-border" style="padding: 100px 5px 50px 5px">
...
?>
  ...
  <p class="w3-large"> Email: <a href="mailto:lppm@nusaputra.ac.id" target="_blank">lppm@nusaputra.ac.id</a></p>
